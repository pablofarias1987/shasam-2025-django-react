...
export default function Technology() {
    ...
    return(<Layout>
        ...
        <div className={style.div_1}>
            ...
            <br></br><br></br>La adicción a las redes sociales y a los videojuegos está escalando muy rápidamente en el ranking de adicciones más comunes. La depresión o la dependencia de likes para equilibrar nuestro autoestima son síntomas muy comunes y negativos relacionados con las redes.
            </p>
